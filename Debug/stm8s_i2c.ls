 ...
 417                     ; 157     I2C->TRISER = (uint8_t)tmpval;
 419  00b9 7b06          	ld	a,(OFST-3,sp)
 420  00bb c7521d        	ld	21021,a
 422  00be 2043          	jra	L141
 423  00c0               L131:
 424                     ; 164     result = (uint16_t)((InputClockFrequencyMHz * 1000000) / (OutputClockFrequencyHz << (uint8_t)1));
 ...
 514  013c 81            	ret
 569                     ; 202 void I2C_Cmd(FunctionalState NewState)
 569                     ; 203 {
 570                     .text:	section	.text,new
 571  0000               _I2C_Cmd:
 575                     ; 205   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 577                     ; 207   if (NewState != DISABLE)
 579  0000 4d            	tnz	a
 580  0001 2706          	jreq	L371
 581                     ; 210     I2C->CR1 |= I2C_CR1_PE;
 583  0003 72105210      	bset	21008,#0
 585  0007 2004          	jra	L571
 586  0009               L371:
 587                     ; 215     I2C->CR1 &= (uint8_t)(~I2C_CR1_PE);
 589  0009 72115210      	bres	21008,#0
 590  000d               L571:
 591                     ; 217 }
 594  000d 81            	ret
 629                     ; 225 void I2C_GeneralCallCmd(FunctionalState NewState)
 629                     ; 226 {
 630                     .text:	section	.text,new
 631  0000               _I2C_GeneralCallCmd:
 635                     ; 228   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 637                     ; 230   if (NewState != DISABLE)
 639  0000 4d            	tnz	a
 640  0001 2706          	jreq	L512
 641                     ; 233     I2C->CR1 |= I2C_CR1_ENGC;
 643  0003 721c5210      	bset	21008,#6
 645  0007 2004          	jra	L712
 646  0009               L512:
 647                     ; 238     I2C->CR1 &= (uint8_t)(~I2C_CR1_ENGC);
 ...
 711                     ; 265 }
 714  000d 81            	ret
 749                     ; 273 void I2C_GenerateSTOP(FunctionalState NewState)
 749                     ; 274 {
 750                     .text:	section	.text,new
 751  0000               _I2C_GenerateSTOP:
 755                     ; 276   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 757                     ; 278   if (NewState != DISABLE)
 759  0000 4d            	tnz	a
 760  0001 2706          	jreq	L162
 761                     ; 281     I2C->CR2 |= I2C_CR2_STOP;
 763  0003 72125211      	bset	21009,#1
 765  0007 2004          	jra	L362
 766  0009               L162:
 767                     ; 286     I2C->CR2 &= (uint8_t)(~I2C_CR2_STOP);
 769  0009 72135211      	bres	21009,#1
 770  000d               L362:
 771                     ; 288 }
 774  000d 81            	ret
 810                     ; 296 void I2C_SoftwareResetCmd(FunctionalState NewState)
 810                     ; 297 {
 811                     .text:	section	.text,new
 812  0000               _I2C_SoftwareResetCmd:
 816                     ; 299   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 818                     ; 301   if (NewState != DISABLE)
 820  0000 4d            	tnz	a
 821  0001 2706          	jreq	L303
 822                     ; 304     I2C->CR2 |= I2C_CR2_SWRST;
 824  0003 721e5211      	bset	21009,#7
 826  0007 2004          	jra	L503
 827  0009               L303:
 828                     ; 309     I2C->CR2 &= (uint8_t)(~I2C_CR2_SWRST);
 830  0009 721f5211      	bres	21009,#7
 831  000d               L503:
 832                     ; 311 }
 835  000d 81            	ret
 871                     ; 320 void I2C_StretchClockCmd(FunctionalState NewState)
 871                     ; 321 {
 872                     .text:	section	.text,new
 873  0000               _I2C_StretchClockCmd:
 877                     ; 323   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 879                     ; 325   if (NewState != DISABLE)
 881  0000 4d            	tnz	a
 882  0001 2706          	jreq	L523
 883                     ; 328     I2C->CR1 &= (uint8_t)(~I2C_CR1_NOSTRETCH);
 885  0003 721f5210      	bres	21008,#7
 887  0007 2004          	jra	L723
 888  0009               L523:
 889                     ; 334     I2C->CR1 |= I2C_CR1_NOSTRETCH;
 891  0009 721e5210      	bset	21008,#7
 892  000d               L723:
 893                     ; 336 }
 896  000d 81            	ret
 932                     ; 345 void I2C_AcknowledgeConfig(I2C_Ack_TypeDef Ack)
 932                     ; 346 {
 933                     .text:	section	.text,new
 934  0000               _I2C_AcknowledgeConfig:
 936  0000 88            	push	a
 937       00000000      OFST:	set	0
 940                     ; 348   assert_param(IS_I2C_ACK_OK(Ack));
 942                     ; 350   if (Ack == I2C_ACK_NONE)
 944  0001 4d            	tnz	a
 945  0002 2606          	jrne	L743
 946                     ; 353     I2C->CR2 &= (uint8_t)(~I2C_CR2_ACK);
 948  0004 72155211      	bres	21009,#2
 950  0008 2014          	jra	L153
 951  000a               L743:
 952                     ; 358     I2C->CR2 |= I2C_CR2_ACK;
 954  000a 72145211      	bset	21009,#2
 955                     ; 360     if (Ack == I2C_ACK_CURR)
 957  000e 7b01          	ld	a,(OFST+1,sp)
 958  0010 a101          	cp	a,#1
 959  0012 2606          	jrne	L353
 960                     ; 363       I2C->CR2 &= (uint8_t)(~I2C_CR2_POS);
 962  0014 72175211      	bres	21009,#3
 964  0018 2004          	jra	L153
 965  001a               L353:
 966                     ; 368       I2C->CR2 |= I2C_CR2_POS;
...
1124                     ; 408   assert_param(IS_I2C_DUTYCYCLE_OK(I2C_DutyCycle));
1126                     ; 410   if (I2C_DutyCycle == I2C_DUTYCYCLE_16_9)
1128  0000 a140          	cp	a,#64
1129  0002 2606          	jrne	L534
1130                     ; 413     I2C->CCRH |= I2C_CCRH_DUTY;
...
1140                     ; 420 }
1143  000e 81            	ret
1166                     ; 427 uint8_t I2C_ReceiveData(void)
1166                     ; 428 {
1167                     .text:	section	.text,new
1168  0000               _I2C_ReceiveData:
1172                     ; 430   return ((uint8_t)I2C->DR);
1174  0000 c65216        	ld	a,21014
1177  0003 81            	ret
1242                     ; 440 void I2C_Send7bitAddress(uint8_t Address, I2C_Direction_TypeDef Direction)
1242                     ; 441 {
1243                     .text:	section	.text,new
1244  0000               _I2C_Send7bitAddress:
1246  0000 89            	pushw	x
1247       00000000      OFST:	set	0
1250                     ; 443   assert_param(IS_I2C_ADDRESS_OK(Address));
1252                     ; 444   assert_param(IS_I2C_DIRECTION_OK(Direction));
1254                     ; 447   Address &= (uint8_t)0xFE;
1256  0001 7b01          	ld	a,(OFST+1,sp)
1257  0003 a4fe          	and	a,#254
1258  0005 6b01          	ld	(OFST+1,sp),a
1259                     ; 450   I2C->DR = (uint8_t)(Address | (uint8_t)Direction);
...
1267  000e 85            	popw	x
1268  000f 81            	ret
1302                     ; 458 void I2C_SendData(uint8_t Data)
1302                     ; 459 {
1303                     .text:	section	.text,new
1304  0000               _I2C_SendData:
1308                     ; 461   I2C->DR = Data;
1310  0000 c75216        	ld	21014,a
1311                     ; 462 }
1314  0003 81            	ret
1538                     ; 578 ErrorStatus I2C_CheckEvent(I2C_Event_TypeDef I2C_Event)
1538                     ; 579 {
...
1547                     ; 580   __IO uint16_t lastevent = 0x00;
1549  0003 5f            	clrw	x
1550  0004 1f04          	ldw	(OFST-2,sp),x
1551                     ; 581   uint8_t flag1 = 0x00 ;
1553                     ; 582   uint8_t flag2 = 0x00;
1555                     ; 583   ErrorStatus status = ERROR;
1557                     ; 586   assert_param(IS_I2C_EVENT_OK(I2C_Event));
1559                     ; 588   if (I2C_Event == I2C_EVENT_SLAVE_ACK_FAILURE)
1561  0006 1e07          	ldw	x,(OFST+1,sp)
1562  0008 a30004        	cpw	x,#4
1563  000b 260b          	jrne	L136
1564                     ; 590     lastevent = I2C->SR2 & I2C_SR2_AF;
...
1599  0037               L336:
1600                     ; 599   if (((uint16_t)lastevent & (uint16_t)I2C_Event) == (uint16_t)I2C_Event)
...
1720                     ; 645     lastevent = ((uint16_t)((uint16_t)flag2 << 8) | (uint16_t)flag1);
...
1731  002e               L176:
1732                     ; 648   return (I2C_Event_TypeDef)lastevent;
1734  002e 1e05          	ldw	x,(OFST-1,sp)
1737  0030 5b06          	addw	sp,#6
1738  0032 81            	ret
1953                     ; 679 FlagStatus I2C_GetFlagStatus(I2C_Flag_TypeDef I2C_Flag)
1953                     ; 680 {
...
1962                     ; 681   uint8_t tempreg = 0;
1964  0002 0f02          	clr	(OFST+0,sp)
1965                     ; 682   uint8_t regindex = 0;
1967                     ; 683   FlagStatus bitstatus = RESET;
1969                     ; 686   assert_param(IS_I2C_FLAG_OK(I2C_Flag));
1971                     ; 689   regindex = (uint8_t)((uint16_t)I2C_Flag >> 8);
1973  0004 9e            	ld	a,xh
1974  0005 6b01          	ld	(OFST-1,sp),a
1975                     ; 691   switch (regindex)
...
1987  0014               L376:
1988                     ; 694     case 0x01:
1988                     ; 695       tempreg = (uint8_t)I2C->SR1;
...
1995  001b               L576:
1996                     ; 699     case 0x02:
1996                     ; 700       tempreg = (uint8_t)I2C->SR2;
...
2003  0022               L776:
2004                     ; 704     case 0x03:
2004                     ; 705       tempreg = (uint8_t)I2C->SR3;
...
2100                     ; 768   I2C->SR2 = (uint8_t)((uint16_t)(~flagpos));
...
2108  000f 85            	popw	x
2109  0010 81            	ret
2275                     ; 791 ITStatus I2C_GetITStatus(I2C_ITPendingBit_TypeDef I2C_ITPendingBit)
2275                     ; 792 {
...
2284                     ; 793   ITStatus bitstatus = RESET;
2286                     ; 794   __IO uint8_t enablestatus = 0;
2288  0003 0f03          	clr	(OFST-1,sp)
2289                     ; 795   uint16_t tempregister = 0;
2291                     ; 798     assert_param(IS_I2C_ITPENDINGBIT_OK(I2C_ITPendingBit));
2293                     ; 800   tempregister = (uint8_t)( ((uint16_t)((uint16_t)I2C_ITPendingBit & ITEN_Mask)) >> 8);
...
2307                     ; 803   enablestatus = (uint8_t)(I2C->ITR & ( uint8_t)tempregister);
2309  0013 c6521a        	ld	a,21018
2310  0016 1402          	and	a,(OFST-2,sp)
2311  0018 6b03          	ld	(OFST-1,sp),a
2312                     ; 805   if ((uint16_t)((uint16_t)I2C_ITPendingBit & REGISTER_Mask) == REGISTER_SR1_Index)
...
2324                     ; 808     if (((I2C->SR1 & (uint8_t)I2C_ITPendingBit) != RESET) && enablestatus)
...
2352                     ; 825       bitstatus = SET;
2354  004a a601          	ld	a,#1
2355  004c 6b04          	ld	(OFST+0,sp),a
2357  004e 2002          	jra	L7311
2358  0050               L1411:
2359                     ; 830       bitstatus = RESET;
2361  0050 0f04          	clr	(OFST+0,sp)
2362  0052               L7311:
2363                     ; 834   return  bitstatus;
2365  0052 7b04          	ld	a,(OFST+0,sp)
2368  0054 5b06          	addw	sp,#6
2369  0056 81            	ret
2414                     ; 871 void I2C_ClearITPendingBit(I2C_ITPendingBit_TypeDef I2C_ITPendingBit)
2414                     ; 872 {
2415                     .text:	section	.text,new
2416  0000               _I2C_ClearITPendingBit:
2418  0000 89            	pushw	x
2419       00000002      OFST:	set	2
2422                     ; 873   uint16_t flagpos = 0;
2424                     ; 876   assert_param(IS_I2C_CLEAR_ITPENDINGBIT_OK(I2C_ITPendingBit));
2426                     ; 879   flagpos = (uint16_t)I2C_ITPendingBit & FLAG_Mask;
...
2434                     ; 882   I2C->SR2 = (uint8_t)((uint16_t)~flagpos);
